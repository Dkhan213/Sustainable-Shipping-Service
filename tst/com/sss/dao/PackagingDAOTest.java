...
class PackagingDAOTest {
    ...
    @Test
    public void findShipmentOptions_multipleIdenticalPackagingOptions_returnsSingleOption() throws Exception {
        // GIVEN
        ...
        assertEquals(1, shipmentOptions.size(),
                "Should not return duplicate options");
    }
    ...
    public void findShipmentOptions_unknownFulfillmentCenter_throwsUnknownFulfillmentCenterException() {
        ...
        // WHEN + THEN
        Assertions.assertThrows(UnknownFulfillmentCenterException.class, () -> {
    ...
    public void findShipmentOptions_packagingDoesntFit_throwsNoPackagingFitsItemException() {
        ...
        // WHEN + THEN
        Assertions.assertThrows(NoPackagingFitsItemException.class, () -> {
