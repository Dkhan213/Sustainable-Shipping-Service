...
import com.sss.test.helper.FreeFormTextHelper;
...
public final class AtaAssertions {
    ...
    public static void assertContainsBetween(final String content,
        ...
        Assertions.assertTrue(FreeFormTextHelper.getValueBetweenPatterns(content, startPattern, endPattern).isPresent(), message);
        assertTrue(StringUtils.isNotBlank(FreeFormTextHelper.getValueBetweenPatterns(content, startPattern, endPattern).get()),
            message);
    ...
    public static void assertMatchesSingleLine(final String content, final String patternToFind, final String message) {
        Assertions.assertTrue(AtaTestHelper.matchesSingleLine(content, patternToFind), message);
    }
