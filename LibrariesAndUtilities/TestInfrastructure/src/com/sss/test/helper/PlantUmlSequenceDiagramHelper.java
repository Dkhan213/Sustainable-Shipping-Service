...
public class PlantUmlSequenceDiagramHelper {
    ...
    public static boolean sequenceDiagramContainsEntity(final String content, final String entity) {
        ...
        return FreeFormTextHelper.matchesMultiLine(content, participantDeclarationPattern) ||
               FreeFormTextHelper.matchesMultiLine(content, entityOnLeftSidePattern) ||
               FreeFormTextHelper.matchesMultiLine(content, entityOnRightSidePattern);
    }
